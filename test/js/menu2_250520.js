$(document).ready(function(){
    /* 스크롤여부, 브라우저 넓이 */
    let scrolling //브라우저에 스크롤 된 정도를 저장
    let win_w //브라우저 넓이
    let device_status //지금 현재 넓이가 pc인지 / 모바일인지 체크
    ...
    */
    ...
    /*
        ...
        >> header .gnb .gnb_open
        메뉴 닫기 버튼을 클랙하면 header에 menu_close 클래스 삭제
